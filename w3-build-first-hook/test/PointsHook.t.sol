...
contract TestPointsHook is Test, Deployers, ERC1155TokenReceiver {
    ...
    function test_addLiquidity() public {
        ...
        uint160 sqrtPriceAtTickLower = TickMath.getSqrtPriceAtTick(-120);
        uint160 sqrtPriceAtTickUpper = TickMath.getSqrtPriceAtTick(120);
        ...
        uint256 pointsBalanceAfterAdd = hook.balanceOf(
            address(this),
            poolIdUint
        );
        // Ensure received points
        uint256 pointsBalanceAfterSwap = hook.balanceOf(
            address(this),
            poolIdUint
        );
        assertEq(pointsBalanceAfterSwap - pointsBalanceOriginal, 0.2 * 0.05 ether);
    }
